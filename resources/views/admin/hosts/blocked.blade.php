        ...
        <div class="content-header">
            <div class="container-fluid">
                ...
                <div class="col-sm-6">
                    ...
                    <li class="breadcrumb-item active">Manage Blocked Hosts</li>
                    </ol>
                </div>
                </div>
            </div>
            ...
            <tbody>
                @forelse ($hosts as $host)
                    <tr>
                        ...
                        <td>
                            <select class="form-select" onchange="updateStatus(this, '{{ route('admin.host.status', ['host' => $host->id]) }}')" data-id="{{ $host->id }}">
