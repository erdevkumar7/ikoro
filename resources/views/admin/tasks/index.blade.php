                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="icon" name="icon" placeholder="Icon code"
                                            ...
                                            <small><a class="text text-danger font-weight-bold" href="https://fontawesome.com/search" target="__blank">Please add fontawsome icon like fa-solid fa-house</a></small>
