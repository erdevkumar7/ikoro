                        ...
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-row tool-details" id="whatsapp_div">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <x-text-input id="whatsapp" class="search-from" type="number"

                                        name="whatsapp" autocomplete="" placeholder="Enter WhatsApp No" />
                            ...
                            <div class="form-row tool-details" id="skype_div">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <x-text-input id="skype" class="search-from" type="text"

                                        name="skype" autocomplete="" placeholder="Enter Skype Id" />
                            ...
                            <a 
                                ...
                                href="{{ route('login') }}" class="login-a">
